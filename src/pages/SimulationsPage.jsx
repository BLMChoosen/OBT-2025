          ...
          >
            <div className="flex items-center p-3 border rounded-md bg-background hover:bg-muted/50 cursor-pointer" onClick={() => { setContactSelected(true); completeStep(3); }}>
              <Avatar className="h-12 w-12 mr-3">
                <AvatarImage src={`${process.env.PUBLIC_URL}/images/ana-silva.jpg`} alt="Ana Silva" />
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 py-12">
      ...
      >
        ...
        <img alt="Pessoa idosa sorrindo enquanto faz uma videochamada em um tablet, com uma interface clara e botões grandes." src={`${process.env.PUBLIC_URL}/images/video-call.jpg`} />
      </motion.div>
    </div>
  );
};
