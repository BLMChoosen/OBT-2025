    ...
    const FamilyPage = () => {
      return (
        <div className="container mx-auto px-6 py-12 min-h-[calc(100vh-200px)] flex flex-col items-center justify-center">
          ...
          <img  alt="Ícones de contatos familiares em uma tela de celular, simbolizando conexão rápida" src="https://images.unsplash.com/photo-1580853504312-082da790e82f" />
        </div>
      );
    };
