    ...
    const gameScenarios = [
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1555940100-55c00553eba8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZW1haWwlMjBpbnRlcmZhY2V8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60',
        options: [
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1611162616805-6790539c169b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bmV3cyUyMHBob25lfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60',
        options: [
      ...
      },
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cGFzc3dvcmR8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60',
        options: [
              ...
              <CardHeader className="text-center p-6 bg-yellow-500/10">
                ...
                {currentGame.imageUrl && (
                  <div className="mt-4 aspect-video w-full max-w-md mx-auto rounded-lg overflow-hidden border-2 border-yellow-300">
                    <img  src={currentGame.imageUrl} alt={currentGame.title} className="w-full h-full object-cover"  src="https://images.unsplash.com/photo-1511512578047-dfb367046420" />
                  </div>
                )}
              </CardHeader>
